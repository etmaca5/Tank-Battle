...
default tank
*/
tank_t *init_default_tank(vector_t center, double side_length, vector_t velocity, double mass, rgb_color_t color, double max_health, size_t tank_type){
    ...
    *type = tank_type;
    tank->shape = body_init_with_info(tank_points, mass, color, type, (free_func_t)body_free);
